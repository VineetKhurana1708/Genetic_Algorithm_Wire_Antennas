...
function [error,Imported_Data]= NEC(MAT,freq)%in Mhz
...
formatSpec = "CM Ex card is correct, errors can be bugs \r\nCE \r\nGW 1 %d %d %d %d %d %d %d  1e-3\r\n" + "GW 2 %d %d %d %d %d %d %d  1e-3\r\n"+"GW 3 %d %d %d %d %d %d %d  1e-3\r\n"+"GW 4 %d %d %d %d %d %d %d  1e-3\r\n"+"GW 5 %d %d %d %d %d %d %d  1e-3\r\n"+"GW 6 %d %d %d %d %d %d %d  1e-3\r\n"+"GW 7 %d %d %d %d %d %d %d  1e-3\r\n"+"GE 1\r\nGN 1 0\r\nEX 0 1 1 0 1 0\r\nFR 0 1 0 0 %d 0\r\nRP 0 19 73 1003 -90 0 5 5 ";
...
error=0;
error=system(strcat('nec2++ -i ',strcat(filename,'.inp'))); % USes arg filename to call NEC .For example , system('nec2++ -i buff.inp')
Imported_Data=[];%Empty matrix needs to be returned if error
if(error==0)
